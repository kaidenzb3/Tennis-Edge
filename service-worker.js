const CACHE="tennis-edge-v2-6-decider-restore-1";
const ASSETS=["./","./index.html","./styles.css","./app.js","./decider.js","./decider-app.js","./manifest.webmanifest","./icon-192.svg","./icon-512.svg"];
